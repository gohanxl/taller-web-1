...
public class ControladorProcesarPago {
    ...
    @RequestMapping(path = "/procesar_pago", method = RequestMethod.POST)
    public ModelAndView procesarPago(
            ...
            @RequestParam("libro_id") Long libro_id*/

    ) throws MPException {
        String estadoDePago = servicioPagar.pagarLibro(token, precio, metodoDePago, cuotas, mail, descripcion, (long) 1);
