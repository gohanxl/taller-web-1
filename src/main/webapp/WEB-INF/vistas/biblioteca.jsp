				...
				<div class="col-lg-3 col-md-6 mb-4">
					<a href="/publicacion/${compra.publicacion.id}">
						...
						<div class="view overlay" style="cursor: pointer">
							<img src="${compra.publicacion.libro.imagen}" class="card-img-top" style="height:200px"
								 alt="">
						</div>
						<div class="card-body text-center">
							<h5>
								<strong>
									<span class="dark-grey-text"><c:out value="${compra.publicacion.libro.nombre}"/></span>
								</strong>
							</h5>
							...
							<a type="button" class="btn btn-light" href="<c:out value="${compra.publicacion.libro.ruta}"/>" target="_blank" style="padding: 5px 20px; margin-top: 20px">
